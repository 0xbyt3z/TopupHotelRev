...
<nav class="px-2 bg-gray-900 border-gray-700">
  <div class="flex justify-between items-center mx-20">
    ...
    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
      <ul class="flex flex-col p-4 mt-4  rounded-lg border  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white bg-gray-800 md:bg-gray-900 border-gray-700">
        <li>
          <a href="/topuphotelrev" class="block py-2 pr-4 pl-3 text-white  rounded   md:p-0 md:text-white bg-blue-600 md:bg-transparent" aria-current="page">Home</a>
        </li>

        <li>
          <a href="pending_reservations.php" class="block py-2 pr-4 pl-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0  md:p-0 ">Dashboard</a>
        </li>

        <!-- Reservation start-->
        <li>
          <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="peer text-white  font-medium rounded-lg text-sm text-center inline-flex items-center" type="button">Reservation
          ...
          <!-- Dropdown menu -->
          <div id="dropdownDivider" class="hidden peer-hover:block hover:block absolute z-10 w-44 bg-white  divide-y divide-gray-100 shadow ">
        ...
        <!-- Rooms start-->
        <li>
          <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="peer text-white  font-medium rounded-lg text-sm text-center inline-flex items-center" type="button">Rooms
            <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
          ...
          <!-- Dropdown menu -->
          <div id="dropdownDivider" class="hidden peer-hover:block hover:block absolute z-10 w-56 bg-white  divide-y divide-gray-100 shadow ">
        ...
        <!-- Customer start-->
        <li>
          <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="peer text-white  font-medium rounded-lg text-sm text-center inline-flex items-center" type="button">Customer
            <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
    ...
    <div>
      ...
      <!-- Dropdown menu -->
      <div id="avatardropdown" class="hidden peer-hover:block hover:block absolute z-10 w-44 bg-white  divide-y divide-gray-100 shadow ">
