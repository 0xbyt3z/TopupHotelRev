...
<div class="top-0 sticky bg-white shadow-lg h-16 w-screen flex items-center justify-end z-50">
    ...
    <a href="cussignup.php" class="text-gray-500 mx-3">Signup</a>
    <div>
        <div class="rounded-full w-8 h-8 bg-white mr-10 ml-3" onclick="toggleAvatarDropDown();">
            ...
            <div id="nav-avatar-dropdown" onmouseleave="toggleAvatarDropDown()" class="invisible absolute right-5 w-24 h-auto pb-2 mt-2 shadow-lg bg-white  hover:block">
                <div class="flex flex-col py-2 pl-2 w-32 h-auto">
                    <a href="">Link</a>
                    <a href="">Link</a>
                    <a href="">Link</a>
                </div>
